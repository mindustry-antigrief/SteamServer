...
public class SNet implements SteamNetworkingCallback, SteamMatchmakingCallback, SteamFriendsCallback, NetProvider{
    ...
    public SNet(NetProvider provider){
        ...
        Events.on(ServerLoadEvent.class, e -> Core.app.addListener(new ApplicationListener(){
            //read packets
            int length;
    ...
    public void hostServer(int port) throws IOException{
        ...
        smat.createLobby(LobbyType.Invisible, 250);
    ...
    public void onLobbyCreated(SteamResult result, SteamID steamID){
        ...
        if(result == SteamResult.OK){
            ...
            smat.setLobbyData(steamID, "name", Administration.Config.name.string());
